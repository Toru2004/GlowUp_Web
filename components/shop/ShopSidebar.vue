  ...
  <aside class="w-full lg:w-72 flex-shrink-0">
    <div class="sticky top-24 space-y-10">
      ...
      <div class="relative group">
        <Search class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-glow-primary-500 transition-colors" />
        <input 
          type="text" 
          :value="searchQuery"
      ...
      <!-- Categories -->
      <div>
        <h3 class="font-serif text-xl border-b border-gray-100 pb-3 mb-6">Danh Mục</h3>
        <div class="space-y-2">
          <button 
      ...
      <!-- Price Filter -->
      <div>
        <h3 class="font-serif text-xl border-b border-gray-100 pb-3 mb-6">Khoảng Giá</h3>
        <div class="space-y-4">
          <div class="flex items-center gap-3">
            <div class="relative flex-1">
              <span class="absolute left-3 top-1/2 -translate-y-1/2 text-[10px] font-bold text-gray-400 uppercase">Từ</span>
              <input 
                type="number" 
            ...
            <div class="relative flex-1">
              <span class="absolute left-3 top-1/2 -translate-y-1/2 text-[10px] font-bold text-gray-400 uppercase">Đến</span>
              <input 
                type="number" 
